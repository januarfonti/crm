...
class add extends AD_Controller {
	...
	{	
		...
		$this->database		= $this->db->dbprefix('blog_category');
	}	
	...
	{				
		...
		else 
		{
			...
			if ($this->insert->saveform($form_data) == TRUE) { redirect('admin/blog/category/#saved'); }
			else { redirect('admin/blog/category/#error'); }
		}
	}
}
?>