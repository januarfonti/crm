<?php  
echo '
'.form_open_multipart('admin/blog/add', $this->gform).'
		...
		<div class="span12">
			...
			<div class="control-group">
				<label class="control-label">Status</label>
					<div class="controls">
						<input class="input-xxlarge" id="status" type="text" name="status" >
			...
			<div class="control-group">
				<label class="control-label">Content</label>
					<div class="controls">
						<textarea id="content" class="span6 " rows="8" name="content"></textarea>
					</div>
			</div>
